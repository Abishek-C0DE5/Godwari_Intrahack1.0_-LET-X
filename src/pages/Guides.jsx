  ...
  return (
    <div className="max-w-7xl mx-auto w-full px-6 py-12">
      <div className="mb-10 text-center max-w-2xl mx-auto animate-fade-in-up">
        ...
        <h1 className="text-4xl font-bold text-slate-900 tracking-tight mb-4">Local Guides</h1>
      ...
      {loading ? (
        <div className="text-center py-20 text-slate-500">Loading guides...</div>
      ) : guides.length === 0 ? (
        <div className="text-center py-20 text-slate-500">No guides found.</div>
      ) : (
