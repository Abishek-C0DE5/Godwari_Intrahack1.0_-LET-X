      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-1 space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 space-y-4">
            <h3 className="font-bold text-gray-900">Travel Stats</h3>
            <div className="flex justify-between items-center py-2 border-b border-gray-50">
              <span className="text-gray-500 flex items-center gap-2"><MapPin className="w-4 h-4"/> Places Visited</span>
              <span className="font-bold text-gray-900">4</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-gray-50">
              <span className="text-gray-500 flex items-center gap-2"><Navigation className="w-4 h-4"/> Guides Hired</span>
              <span className="font-bold text-gray-900">2</span>
            </div>
            <div className="flex justify-between items-center py-2">
              <span className="text-gray-500 flex items-center gap-2"><Activity className="w-4 h-4"/> Active Bookings</span>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
            ...
            <form onSubmit={handleSave} className="space-y-5">
              ...
              <div>
                ...
                <input type="email" value={user.email} disabled className="w-full bg-gray-100 border border-gray-200 text-gray-500 rounded-xl px-4 py-3 cursor-not-allowed" />
        ...
        <div>
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden sticky top-8">
            <div className="aspect-[4/3] relative overflow-hidden bg-gray-100">
              ...
              />
              <div className="absolute top-4 left-4 bg-white/90 backdrop-blur px-3 py-1.5 rounded-lg text-xs font-bold text-gray-900 uppercase tracking-wider">
                Local Guide
              </div>
            </div>
            <div className="p-6">
              <div className="flex justify-between items-start mb-2">
                <h3 className="text-2xl font-black text-gray-900">{formData.name || 'Your Name'}</h3>
              ...
              <div className="pt-6 border-t border-gray-100 flex items-center justify-between">
                <div className="font-bold text-gray-900 text-lg">{formData.price || 'Your Rate'}</div>
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="mb-4 text-center">
        ...
        <p className="text-gray-500 mt-2">Manage how your hotel appears in the YatraVerse directory.</p>
      </div>
      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-bold text-gray-900 border-b border-gray-100 pb-2">Details & Amenities</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Amenities</label>
                <input type="text" value={formData.specialties} onChange={(e) => setFormData({...formData, specialties: e.target.value})} placeholder="WiFi, Pool, Spa" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 font-medium" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Starting Price (NPR)</label>
                <input type="text" value={formData.price} onChange={(e) => setFormData({...formData, price: e.target.value})} className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 font-medium" />
              </div>
            </div>
            <div>
          ...
          <div className="pt-6 border-t border-gray-100 text-center">
            <button type="submit" disabled={isSaving} className="bg-blue-600 text-white px-12 py-4 rounded-xl font-bold hover:bg-blue-700 transition-colors inline-flex items-center gap-2 shadow-sm">
