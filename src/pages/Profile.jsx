  ...
  return (
    <div className="space-y-8">
      <div className="mb-4">
        ...
        <p className="text-gray-300 mt-1">Manage your traveler identity and preferences.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-1 space-y-6">
          <div className="bg-blue-700 text-white shadow-md shadow-blue-900/50 shadow-xl rounded-3xl p-8 shadow-md relative overflow-hidden">
            <div className="absolute -right-4 -bottom-4 opacity-10"><Award className="w-40 h-40" /></div>
            <div className="w-16 h-16 bg-white/10 backdrop-blur-md border border-white/20 shadow-xl/20 rounded-2xl flex items-center justify-center text-white mb-6 backdrop-blur-sm">
              <User className="w-8 h-8" />
            </div>
            <h2 className="text-2xl font-bold mb-1 relative z-10">{profile.name}</h2>
            <h3 className="font-medium text-gray-400 mb-6 relative z-10 uppercase tracking-widest text-xs">YatraVerse Explorer</h3>
            
            <div className="flex justify-between items-end relative z-10 pt-6 border-t border-blue-500/50">
              <div>
                <div className="text-xs text-gray-400 uppercase tracking-wider mb-1">Total Points</div>
                <div className="text-3xl font-black">{profile.points?.toLocaleString() || 0}</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-gray-400 uppercase tracking-wider mb-1">Global Rank</div>
                <div className="text-3xl font-black">#{rank || '-'}</div>
              </div>
            </div>
          </div>

          <div className="bg-white/10 backdrop-blur-md border border-white/20 shadow-xl rounded-3xl p-6 shadow-sm border border-white/10 space-y-4">
            <h3 className="font-bold text-white">Travel Stats</h3>
            <div className="flex justify-between items-center py-2 border-b border-gray-50">
              <span className="text-gray-300 flex items-center gap-2"><MapPin className="w-4 h-4"/> Places Visited</span>
              <span className="font-bold text-white">4</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-gray-50">
              <span className="text-gray-300 flex items-center gap-2"><Navigation className="w-4 h-4"/> Guides Hired</span>
              <span className="font-bold text-white">2</span>
            </div>
            <div className="flex justify-between items-center py-2">
              <span className="text-gray-300 flex items-center gap-2"><Activity className="w-4 h-4"/> Active Bookings</span>
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 shadow-xl rounded-3xl p-8 shadow-sm border border-white/10">
            ...
            <form onSubmit={handleSave} className="space-y-5">
              ...
              <div>
                ...
                <input type="email" value={user.email} disabled className="w-full bg-gray-100 border border-white/10 text-gray-300 rounded-xl px-4 py-3 cursor-not-allowed" />
                <p className="text-xs text-gray-400 mt-2 flex items-center gap-1"><Shield className="w-3 h-3"/> Email is verified and secured.</p>
              </div>
              {message && <div className="p-3 rounded-xl bg-green-50 text-green-700 text-sm font-medium">{message}</div>}
              <div className="pt-2">
                <button type="submit" disabled={isSaving} className="flex items-center gap-2 bg-blue-700 text-white shadow-md shadow-blue-900/50 shadow-xl px-8 py-3 rounded-xl font-bold hover:bg-blue-800 transition-colors disabled:bg-blue-300">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 shadow-xl rounded-3xl p-8 shadow-sm border border-white/10">
            ...
            <div className="flex flex-wrap gap-3">
              {['Trekking', 'Cultural Heritage', 'Photography', 'Wildlife Safari', 'Local Cuisine', 'Homestays'].map(tag => (
                <span key={tag} className="px-5 py-2.5 bg-transparent border border-white/10 rounded-xl text-sm font-medium text-gray-200 cursor-pointer hover:bg-blue-50 hover:text-blue-600 hover:border-blue-200 transition-colors shadow-sm">
                  {tag}
                </span>
              ))}
            </div>
  ...
  return (
    <div className="space-y-8">
      <div className="mb-4">
        ...
        <p className="text-gray-300 mt-1">Design how tourists see you on the platform.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 shadow-xl rounded-3xl shadow-lg border border-white/10 overflow-hidden sticky top-8">
            <div className="aspect-[4/3] relative overflow-hidden bg-gray-100">
              ...
              />
              <div className="absolute top-4 left-4 bg-white/10 backdrop-blur-md border border-white/20 shadow-xl/90 backdrop-blur px-3 py-1.5 rounded-lg text-xs font-bold text-white uppercase tracking-wider">
                Local Guide
              </div>
            </div>
            <div className="p-6">
              <div className="flex justify-between items-start mb-2">
                <h3 className="text-2xl font-black text-white">{formData.name || 'Your Name'}</h3>
                <div className="flex items-center gap-1 text-sm font-bold text-gray-200 bg-yellow-50 text-yellow-700 px-2.5 py-1 rounded-md">
              ...
              <div className="pt-6 border-t border-white/10 flex items-center justify-between">
                <div className="font-bold text-white text-lg">{formData.price || 'Your Rate'}</div>
                <button disabled className="bg-gray-100 text-gray-400 font-bold px-6 py-2.5 rounded-xl text-sm">Contact Me</button>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Edit Form */}
        <div>
          <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-4">Edit Details</h2>
          <div className="bg-white/10 backdrop-blur-md border border-white/20 shadow-xl rounded-3xl p-8 shadow-sm border border-white/10">
            {message && <div className="mb-6 p-4 rounded-xl bg-green-50 text-green-700 font-medium">{message}</div>}
            <form onSubmit={handleSave} className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-bold text-gray-200 mb-2">Display Name</label>
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-200 mb-2">Base Location</label>
              ...
              <div>
                <label className="block text-sm font-bold text-gray-200 mb-2">Specialties / Tags</label>
              ...
              <div>
                <label className="block text-sm font-bold text-gray-200 mb-2">Daily Rate</label>
              ...
              <div>
                <label className="block text-sm font-bold text-gray-200 mb-2">Profile Photo URL</label>
              ...
              <div>
                <label className="block text-sm font-bold text-gray-200 mb-2">Full Bio</label>
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="mb-4 text-center">
        ...
        <p className="text-gray-300 mt-2">Manage how your hotel appears in the YatraVerse directory.</p>
      </div>
      ...
      <div className="bg-white/10 backdrop-blur-md border border-white/20 shadow-xl rounded-3xl p-8 shadow-sm border border-white/10">
        ...
        <div className="w-full h-48 bg-gray-100 rounded-2xl mb-8 relative overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
            <span className="text-white font-bold flex items-center gap-2"><ImageIcon className="w-5 h-5"/> Update Photo via URL below</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-gray-200 mb-2">Property Name</label>
                <input type="text" value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})} className="w-full bg-transparent border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 font-medium" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-200 mb-2">Location Address</label>
                <input type="text" value={formData.location} onChange={(e) => setFormData({...formData, location: e.target.value})} className="w-full bg-transparent border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 font-medium" />
              </div>
            </div>
            <div>
                <label className="block text-sm font-bold text-gray-200 mb-2">Cover Photo URL</label>
                <input type="url" value={formData.avatar_url} onChange={(e) => setFormData({...formData, avatar_url: e.target.value})} className="w-full bg-transparent border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 font-medium" />
            </div>
          </div>

          <div className="space-y-6">
            <h3 className="text-lg font-bold text-white border-b border-white/10 pb-2">Details & Amenities</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-gray-200 mb-2">Amenities</label>
              ...
              <div>
                <label className="block text-sm font-bold text-gray-200 mb-2">Starting Price (NPR)</label>
            ...
            <div>
              <label className="block text-sm font-bold text-gray-200 mb-2">Property Description</label>
              <textarea value={formData.description} onChange={(e) => setFormData({...formData, description: e.target.value})} rows="4" className="w-full bg-transparent border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 font-medium"></textarea>
            </div>
          </div>

          <div className="pt-6 border-t border-white/10 text-center">
            <button type="submit" disabled={isSaving} className="bg-blue-700 text-white shadow-md shadow-blue-900/50 shadow-xl px-12 py-4 rounded-xl font-bold hover:bg-blue-800 transition-colors inline-flex items-center gap-2 shadow-sm">
